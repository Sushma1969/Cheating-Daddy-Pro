            ...
            <div class="help-container">
                ...
                <div class="option-group">
                    ...
                    <div class="usage-steps">
                        ...
                        <div class="usage-step"><strong>For OA & Coding Test (Exam Assistant):</strong> Select the Exam Assistant profile to use screenshot-based analysis. Available models: <strong>Gemini 3.5 Flash</strong>, <strong>Gemini 3 Flash Preview</strong> and <strong>Gemini 3.1 Pro Preview</strong>. Requires a Gemini API key.</div>
