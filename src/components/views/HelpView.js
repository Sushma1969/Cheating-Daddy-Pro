            ...
            <div class="help-container">
                <div class="option-group">
                    ...
                    <div class="community-links">
                        ...
                        <div class="community-link" @click=${() => this.handleExternalLinkClick('https://github.com/Sushma1969/Cheating-Daddy-Pro')}>
                            📂 GitHub Repository
                        </div>
                ...
                <div class="option-group">
                    ...
                    <div class="usage-steps">
                        <div class="usage-step"><strong>Enter Groq API Key:</strong> After a fresh install, you'll land on the setup screen. Enter your Groq API key to get started with the Qwen model and interview sessions.</div>
                        ...
                        <div class="usage-step"><strong>For OA & Coding Test (Exam Assistant):</strong> Select the Exam Assistant profile to use screenshot-based analysis. Available models: <strong>Gemini 3.5 Flash</strong>, <strong>Gemini 3 Flash Preview</strong>, <strong>Gemini 3.1 Pro Preview</strong> (paid), <strong>Gemini 2.5 Pro</strong> (paid), <strong>Gemini 2.5 Flash</strong> (free and Google Search) and <strong>Qwen 3.6 27B</strong> (Groq key only). Gemini models require a Gemini API key.</div>
                        <div class="usage-step"><strong>For Interview Profiles:</strong> All other profiles use real-time audio interview mode. Available models: <strong>Gemini 2.5 Flash Lite</strong>, <strong>Gemini 3.1 Flash Lite</strong>, and <strong>Qwen 3.6 27B</strong>.</div>
                        <div class="usage-step"><strong>API Keys for Interview Mode:</strong> For <strong>Qwen 3.6 27B</strong>, only a Groq API key is needed. For the <strong>Gemini Flash Lite</strong> models, you must enter both your Groq API key and Gemini API key.</div>
